...
final studentsForTeacherProvider = FutureProvider.autoDispose<List<Map<String, dynamic>>>((ref) {
  return ref.watch(progressRepositoryProvider).fetchStudentsForTeacher();
});

/// Children visible to the signed-in parent: `[{id, full_name}, ...]`.
final childrenForParentProvider = FutureProvider.autoDispose<List<Map<String, dynamic>>>((ref) {
...
final unitMasteryProvider = FutureProvider.autoDispose.family<List<Map<String, dynamic>>, String>((
  ref,
  studentId,
) {
...
final dailyPointsProvider = FutureProvider.autoDispose.family<List<Map<String, dynamic>>, String>((
  ref,
  studentId,
) {
